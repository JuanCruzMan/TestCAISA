<%@ Page Language="C#" MasterPageFile="~/TestMaster.Master" CodeBehind="EditDatos.aspx.cs" Inherits="WebAppTest.EditDatos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <table style="width: 100%; height: 146px;">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button2" runat="server" OnClientClick="return confirm('Desea continuar?');" Text="Button" OnClick="Button2_Click" />
            </td>
        </tr>
        <tr>
            <td class="auto-style1">
